...
Gebruik de _[!UICONTROL Elements]_sectie van het [!DNL Page Builder] paneel om tekst, rubrieken, knopen, verdelers, en code van de HTML aan om het even welke lay-outcontainer op het [[!DNL Page Builder]  stadium ](workspace.md#stage) toe te voegen. Wanneer u een inhoudstype van het paneel aan of een rij of een kolom, of aan een lusjereeks op het stadium sleept, verschijnt een container. Gebruik de gereedschapset voor inhoudstypen voor toegang tot de instellingen die specifiek zijn voor de tekst.

...
Gebruik het _inhoudstype van de Kaart_ om een kaart van [[!DNL Google Maps]  Platform &#x200B;](https://cloud.google.com/maps-platform/) aan het [[!DNL Page Builder]  stadium &#x200B;](workspace.md#stage) toe te voegen. Bijvoorbeeld, zou u een kaart aan een blok kunnen toevoegen, en dan het blok toevoegen aan [&#x200B; Ongeveer de pagina&#39;s van ons &#x200B;](../content-design/pages.md#about-us) en [&#x200B; Contact &#x200B;](../getting-started/store-details.md#contact-us-form).

Om de meesten van [!DNL Google Maps] Platform te krijgen, kunt u de kaart aanpassen, uw opslagplaatsen benadrukken, en Google [&#x200B; Plaatsen &#x200B;](https://cloud.google.com/maps-platform/places/) gebruiken om rijke informatie over uw opslag aan allen [!DNL Google Maps] toe te voegen.
...
Alvorens een kaart toe te voegen, moet u een [&#x200B; rekening &#x200B;](https://cloud.google.com/maps-platform/user-guide/) voor een vrije proef van [!DNL Google Maps] Platform eerst openen. De gratis proefversie duurt 12 maanden en omvat een krediet van € 300. Als je je creditering opgebruikt, factureert Google je account niet zonder je toestemming.
...
1. Om uw API geloofsbrieven te vormen, volg de [&#x200B; instructies &#x200B;](https://developers.google.com/maps/documentation/javascript/get-api-key) in de [!DNL Google Maps] documenten.
...
1. Verzamel de locatiecoördinaten die u wilt gebruiken voor de aangepaste locatie.
   ...
   Ga zo nodig naar [[!DNL Google Maps] &#x200B;](https://www.google.com/maps) in een nieuw browservenster en gebruik een van de volgende methoden om de coördinaten op te halen:
...
1. Onder het **[!UICONTROL Google Maps Style]** tekstvakje, klik [&#x200B; creeer de Stijl van de Kaart &#x200B;](https://mapstyle.withgoogle.com/).

   Deze actie opent de [[!DNL Google Maps]  Tovenaar van de Stijlvorming van het Platform &#x200B;](https://mapstyle.withgoogle.com/) in een afzonderlijk lusje, waar u een stijl voor uw [!DNL Google Maps] project van het Platform kunt bepalen.

...
1. Om uw API geloofsbrieven te vormen, volg de [ instructies ](https://developers.google.com/maps/documentation/javascript/get-api-key) in de [!DNL Google Maps] documentatie.
...
1. Vouw [!DNL Page Builder] uit in het deelvenster **[!UICONTROL Add Content]** en sleep een tijdelijke aanduiding **[!UICONTROL Block]** naar de nieuwe rij.
...
1. Vouw [!DNL Page Builder] uit in het deelvenster **[!UICONTROL Add Content]** en sleep een tijdelijke aanduiding **[!UICONTROL Dynamic Block]** naar de nieuwe rij.

...
1. Vouw [!DNL Page Builder] uit in het deelvenster **[!UICONTROL Add Content]** en sleep een tijdelijke aanduiding **[!UICONTROL Products]** naar de nieuwe rij.
...
1. Kies **[!UICONTROL Select Products By]** bij `Condition` .
...
1. Klik naast _[!UICONTROL Description]_&#x200B;op **[!UICONTROL Edit with Page Builder]**.
   ...
   Als de productbeschrijving eerder zonder [!DNL Page Builder] was ingegaan, verschijnt de huidige beschrijving als HTML in een [&#x200B; container van de Code van HTML &#x200B;](html-code.md). Bij het thema Luma wordt de productbeschrijving weergegeven op het tabblad Details.

1. Sleep in het deelvenster [!DNL Page Builder] onder _[!UICONTROL Layout]_&#x200B;een **[!UICONTROL Row]**&#x200B;naar het werkgebied en plaats het onder de HTML-codecontainer.
...
1. Vouw [!DNL Page Builder] uit in het deelvenster **[!UICONTROL Media]** en sleep een tijdelijke aanduiding **[!UICONTROL Video]** naar de nieuwe rij.
...
1. Voer de **[!UICONTROL Video URL]** in.
   ...
   De video kan op of [&#x200B; YouTube &#x200B;](https://www.youtube.com/) of [&#x200B; Vimeo &#x200B;](https://vimeo.com/) worden ontvangen. De video in dit voorbeeld is te vinden op YouTube op de volgende URL:
...
1. Voor **Mijn Attribuut van de Bouwer van de Pagina**, klik **[!UICONTROL Edit with Page Builder]** en voeg de beschrijvingstekst toe:
   ...
   - Vouw [!DNL Page Builder] uit in het deelvenster **[!UICONTROL Elements]** en sleep een **[!UICONTROL Text object]** naar het werkgebied.

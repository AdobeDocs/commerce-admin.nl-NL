...
De controles van de paginering verschijnen bij de bodem van de lijst wanneer het totale aantal punten van de verzoeklijst de geselecteerde punten per pagina overschrijdt.

![ Lijst van de Aanvraag met paginering ](./assets/requisition-list-bottom-with-pagination.png){width="700" zoomable="yes"}

>[!NOTE]
>
> Producten die uw aandacht vereisen (bijvoorbeeld producten die buiten de voorraad vallen) worden boven aan de lijst weergegeven als ze binnen de huidige pagina van de paginering vallen. Het aantal producten dat uw aandacht verdient, wordt boven de lijst weergegeven.
> ![Items die aandacht vereisen ](./assets/requisition-list-product-requiring-attention.png){width="500"}

### Besturingselementen voor paginering in Storefront

| Besturing | Beschrijving |
|----------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![ toon per pagina ](./assets/control-pagination-show-per-page.png) | [!UICONTROL Show Per Page] - Hiermee bepaalt u hoeveel items in de aanvraaglijst per pagina worden weergegeven. U kunt kiezen uit de items in de aanvraaglijst 20, 50, 100, 500 of 1000 die u op de pagina wilt weergeven. |
| ![ de verbindingen van de Paginering ](./assets/control-pagination.png) | [!UICONTROL Pagination links] - Verzekert navigatiekoppelingen naar andere pagina&#39;s. |
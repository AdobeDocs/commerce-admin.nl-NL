...
1. [&#x200B; Teken binnen &#x200B;](https://www.google.com/analytics/){: target="_blank"} aan de rekening van Google Analytics van uw bedrijf.
...
Meer leren, zie de [&#x200B; Referentie van het Gebied Analytics.js &#x200B;](https://developers.google.com/analytics/devguides/collection/analyticsjs/field-reference){: target="_blank"} in de Hulp van Google.
...
Meer leren, zie [&#x200B; IP Anonymization in Analytics &#x200B;](https://support.google.com/analytics/answer/2763052) in de Hulp van Google.

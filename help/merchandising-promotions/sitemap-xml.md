...
1. Als u een sitemap wilt genereren, stelt u **[!UICONTROL Enabled]** in op `Yes` en voert u de volgende handelingen uit:
   ...
   - Stel **[!UICONTROL Generation Method]** in op een van de volgende opties:

      - `Standard` - Verwerkt alle gegevens in het geheugen.
      - `Batch` - Gebruikt geheugengeoptimaliseerde verwerking voor grote catalogi. Deze optie is beschikbaar vanaf de release 2.4.9.
...
## Alternatieve afdruktaak voor grote catalogi

>[!NOTE]
>
>Voor winkels met grote catalogi kunt u een alternatieve ronjob gebruiken om ervoor te zorgen dat alle gegevens worden gegenereerd. In `app/code/Magento/Sitemap/etc/config.xml` vervangen:
>
>```xml
><jobs>
>   <sitemap_generate>
...
>```
>
>Deze wijziging maakt het genereren van batchsitemap mogelijk. Dit wordt aanbevolen voor grote catalogi.

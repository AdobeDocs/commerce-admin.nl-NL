...
1. Klik in het dashboard van [!DNL Google Tag Manager] op **[!UICONTROL Google AdWords]** en voer de volgende handelingen uit:
   ...
   - Selecteer **[!UICONTROL AdWords Conversion Tracking]** onder _[!UICONTROL Choose a Tag Type]_&#x200B;en klik op **[!UICONTROL Continue]**.

...
1. ![&#x200B; Magento Open Source &#x200B;](../assets/open-source.svg) (Magento Open Source slechts) ga **[!UICONTROL From]** en **[!UICONTROL To]** data in om te bepalen wanneer de prijsregel in feite is.
   ...
   >[!NOTE]
   >
   >De velden `From` en `To` zijn verwijderd van de configuratiepagina Catalog price rule in Adobe Commerce en kunnen niet rechtstreeks worden gewijzigd op de regel voor catalogusprijzen. U moet een geplande update maken om het schema voor de activering van de prijsregel in te stellen.

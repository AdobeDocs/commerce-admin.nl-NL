...
1. Ga als volgt te werk als u conversie bijhouden voor uw campagne wilt instellen:
   ...
   - Kies **[!UICONTROL Tools]** op het tabblad **[!UICONTROL Conversions]** van het dashboard voor AdWords en klik op **[!UICONTROL Conversion]** .
...
1. Ga als volgt te werk om de melding van de Google-sitestaat op te maken:
   ...
   - Ga de [ hexadecimale code ](https://www.w3schools.com/colors/colors_picker.asp){:target="_blank"} voor **[!UICONTROL Conversion Color]** in die u voor het het berichtetiket van de Staten van de Plaats van Google wilt gebruiken.

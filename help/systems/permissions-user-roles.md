...
1. Stel onder _[!UICONTROL Roles Resources]_&#x200B;de waarde **[!UICONTROL Resource Access]**&#x200B;in op `Custom` .
   ...
   >[!NOTE]
   >
   >Als Two Factor Authentication (2FA) wordt vereist om aan te melden bij Admin, zorg ervoor dat u Middel `Permissions` > `Two Factor Auth` voor deze rol toelaat. Anders kunnen nieuwe gebruikers met dit `Custom` rolwerkingsgebied niet opstelling 2FA wanneer zij tot Admin voor het eerst toegang hebben.
...
>[!VIDEO](https://video.tv.adobe.com/v/3443513?captions=dut&quality=12&learn=on)

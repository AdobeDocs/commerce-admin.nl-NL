...
1. Ga als volgt te werk in de sectie _[!UICONTROL Account Information]_:
   ...
   - Voer een **[!UICONTROL Password]** in voor de account.
     ...
     >[!NOTE]
     >
     >Een beheerderswachtwoord moet uit minimaal zeven tekens bestaan (standaard) en zowel letters als cijfers bevatten. De minimale lengte van wachtwoorden kan worden geconfigureerd in de beveiligingsinstellingen van Admin. Voor extra wachtwoordopties, zie [ Vormend Veiligheid Admin ](security-admin.md).

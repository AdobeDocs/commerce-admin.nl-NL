...
1. Kies _[!UICONTROL Sales]_in de sectie **[!UICONTROL Delivery Methods]**van het linkerdeelvenster.
...
1. Vul de tabel in met de juiste waarden voor de verzendberekeningsvoorwaarde.
   ...
   - De _[!UICONTROL Country]_kolom moet a [ geldige code van drie tekens ](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-3) voor elke rij bevatten.

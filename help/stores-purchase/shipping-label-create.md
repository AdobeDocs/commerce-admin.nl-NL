...
## Stap 1: Neem contact op met de verzenders
...
- **USPS** - verwijs naar het [ Portaal van USPS ](https://developers.usps.com/) om te leren hoe te opstelling uw geloofsbrieven van de etiketdruk.
...
1. Selecteer **[!UICONTROL USPS Type]** als `USPS Rest APIs` of `USPS Web Tools API` .
   ...
   >[!NOTE]
   >
   >USPS biedt geen ondersteuning meer voor de USPS Web Tools API.
...
1. Selecteer **[!UICONTROL DHL Type]** als `DHL REST` of `DHL XML` .

1. Controleer of de volgende gegevens zijn voltooid op basis van de selectie van **[!UICONTROL DHL Type]** :
...
### Methode 2: Labels afdrukken voor meerdere bestellingen
...
| [!UICONTROL Length, Width, Height] | (Optioneel) De pakketafmetingen worden alleen gebruikt voor aangepaste pakketten. U kunt de metingseenheden als duim of centimeters specificeren.<br/><br/>**[!UICONTROL Not Required]**: De verzendende vervoerder verzendt geen bevestiging van levering naar de winkel.<br/><br/>**[!UICONTROL No Signature]**: Een leveringsbevestiging zonder de handtekening van de ontvanger wordt verzonden naar de winkel door de verzendende vervoerder.<br/><br/>**[!UICONTROL Signature Required]**De verzendende vervoerder verkrijgt de handtekening van de ontvanger en verstrekt de winkel een gedrukte kopie.<br/><br/>**[!UICONTROL Direct]** (Alleen FedEx) FedEx verkrijgt een handtekening van iemand op het bezorgadres. Als niemand voor het pakket beschikbaar is te ondertekenen, probeert de drager om het pakket op een ander ogenblik te leveren.<br/><br/>**[!UICONTROL Indirect]**: (Alleen voor FedEx-residentiële leveringen) FedEx verkrijgt de handtekening van iemand (mogelijk een buur of bouwbeheerder) op het bezorgadres. De ontvanger kan een ondertekende FedEx deurmarkering verlaten om het pakket toe te laten om zonder enige aanwezige voor het te ondertekenen.<br/><br/>**[!UICONTROL Contents]**: (Alleen USPS) Selecteer een van de volgende beschrijvingen van het pakket:<br/> - Cadeautje <br/> - Documenten <br/> - Commerciële steekproef <br/> - Geretourneerde goederen <br/> - Merchandise <br/> - Andere <br/><br/>**[!UICONTROL Explanation]**: (Alleen USPS) Een gedetailleerde beschrijving van de inhoud van het pakket.<br/><br/>**[!UICONTROL Adult Required]** De verzendende vervoerder verkrijgt de handtekening van een volwassen ontvanger en verstrekt de winkel een gedrukte kopie. |
...
| [!UICONTROL Width] | De breedte van een pakket, geheel getal en drijvende-kommagetallen. Het veld wordt ingeschakeld als het aangepaste pakkettype wordt gebruikt. U kunt de maateenheden opgeven in het keuzemenu naast het veld Hoogte. Selecteer tussen inches en centimeters. |
| [!UICONTROL Height] | De hoogte van een pakket, geheel getal en drijvende-kommagetallen. Het veld wordt ingeschakeld als het aangepaste pakkettype wordt gebruikt. U kunt de maateenheden opgeven in het keuzemenu naast het veld Hoogte. Selecteer tussen inches en centimeters. |
| [!UICONTROL Signature] | Definieert leveringsbevestiging. Opties:<br/><br/>**[!UICONTROL Not Required]**: Er wordt geen bevestigingsbrief voor de levering verzonden.<br/><br/>**[!UICONTROL No Signature]** Een brief van de leveringsbevestiging zonder de handtekening van een ontvanger wordt verzonden naar u.<br/><br/>**[!UICONTROL Signature Required]**: De verzendende vervoerder verkrijgt de handtekening van de ontvanger en verstrekt u zijn gedrukte exemplaar.<br/><br/>**[!UICONTROL Adult Required]**: De verschepende vervoerder verkrijgt de handtekening van de volwassen ontvanger en verstrekt u zijn gedrukt exemplaar.<br/><br/>**[!UICONTROL Direct (FedEx only)]**: FedEx verkrijgt een handtekening van iemand op het leveringsadres en maakt levering opnieuw als niemand voor het pakket beschikbaar is.<br/><br/>**[!UICONTROL Indirect (FedEx only)]**: FedEx verkrijgt een handtekening op één van drie manieren:<br/> (1) van iemand bij het leveringsadres; <br/> (2) van een buur, bouwmanager, of een andere persoon op het adres; of <br/>(3) de ontvanger een ondertekende FedEx-deurtag kan verlaten waarmee het pakket kan worden vrijgegeven zonder dat er iemand aanwezig is. Alleen beschikbaar voor leveringen in woningen. De opties kunnen enigszins afwijken voor verschillende verzendmethoden. Raadpleeg voor de meest recente informatie de bronnen van de scheepvaartmaatschappij. |

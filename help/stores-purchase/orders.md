...
![&#x200B; de Acties van de orde 0&rbrace;](./assets/orders-action.png){width="600" zoomable="yes"}
...
1. Om de selectie van onderzoeksfilters te tonen, klik de _Filters_ ( ![&#x200B; het pictogram van Funnel &#x200B;](../assets/icon-filter-search.png)) tabel.

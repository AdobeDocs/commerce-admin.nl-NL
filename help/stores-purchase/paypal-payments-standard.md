...
[&#x200B; PayPal de Norm van Betalingen &#x200B;](https://developer.paypal.com/docs/paypal-payments-standard/mobile-paypal-payments-standard/) is de gemakkelijkste manier om betalingen online goed te keuren. Je kunt je klanten het gemak van betaling aanbieden, zowel via creditcard als via PayPal, door gewoon een button Afhandeling aan je winkel toe te voegen.
...
1. {de Orde van de Plaatsen van de Klant van 0} **- de klant klikt of tikt** nu betalen _knoop om de aankoop te voltooien._

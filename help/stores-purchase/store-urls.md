...
Als een beveiligingscertificaat niet beschikbaar was voor het domein op het moment van de installatie, moet u de configuratie bijwerken voordat u de winkel start. Nadat een veiligheidscertificaat voor uw domein wordt gevestigd, kunt u één van beide of beide basis URLs vormen om met gecodeerde Veilige Laag van Contactdozen (SSL) en [&#x200B; het protocol van de Veiligheid van de Laag van het Vervoer van de Laag &#x200B;](https://en.wikipedia.org/wiki/Transport_Layer_Security) (TLS) in werking te stellen.

...
| [!UICONTROL Number] [!BADGE  slechts SaaS ]{type=Positive url="https://experienceleague.adobe.com/en/docs/commerce/user-guides/product-solutions" tooltip="Alleen van toepassing op Adobe Commerce as a Cloud Service- en Adobe Commerce Optimizer-projecten (door Adobe beheerde SaaS-infrastructuur)."} | Een numeriek invoerveld waarin decimale waarden worden opgeslagen. In tegenstelling tot het **inputtype van de Prijs**, past het geen muntopmaak toe en keurt negatieve waarden goed. Gebruik dit invoertype voor metingen, afmetingen of technische specificaties zoals temperatuurbereiken. |

...
| [!UICONTROL Text Area] | Een invoerveld met meerdere regels voor het invoeren van tekstalinea&#39;s, zoals een productbeschrijving. U kunt de WYSIWYG Editor gebruiken om de tekst op te maken met HTML-tags of u kunt de tags rechtstreeks in de tekst invoeren. |
...
| [!UICONTROL Number] [!BADGE &#x200B; slechts SaaS &#x200B;]{type=Positive url="https://experienceleague.adobe.com/nl/docs/commerce/user-guides/product-solutions" tooltip="Alleen van toepassing op Adobe Commerce as a Cloud Service- en Adobe Commerce Optimizer-projecten (door Adobe beheerde SaaS-infrastructuur)."} | Een numeriek invoerveld waarin decimale waarden worden opgeslagen. In tegenstelling tot het **inputtype van de Prijs**, past het geen muntopmaak toe en keurt negatieve waarden goed. Gebruik dit invoertype voor metingen, afmetingen of technische specificaties zoals temperatuurbereiken. |
...
| [!UICONTROL File] [!BADGE &#x200B; slechts SaaS &#x200B;]{type=Positive url="https://experienceleague.adobe.com/nl/docs/commerce/user-guides/product-solutions" tooltip="Alleen van toepassing op Adobe Commerce as a Cloud Service- en Adobe Commerce Optimizer-projecten (door Adobe beheerde SaaS-infrastructuur)."} | Hiermee kunt u een bestand uploaden en koppelen aan een productkenmerk. De gesteunde dossiertypes en de maximumdossiergrootte worden gevormd in [&#x200B; Attributen van het Dossier van het Product &#x200B;](../configuration-reference/catalog/product-file-attributes.md). Gebruik dit invoertype voor documenten zoals producthandleidingen, specificatiebladen of certificaten. |
...
**_To formatteren datum/tijdgebieden:_**

...
## Afbeeldingen en video&#39;s beheren op het niveau van de winkelweergave

Wanneer u de **[!UICONTROL Store View]** -kiezer overschakelt naar een specifieke opslagweergave (niet **[!UICONTROL All Store Views]** ), biedt de sectie _[!UICONTROL Images and Videos]_&#x200B;aanvullende besturingselementen voor het beheren van de manier waarop afbeeldingen worden weergegeven voor die winkelweergave zonder dat dit van invloed is op het standaardbereik.

### Afbeeldingen opnieuw ordenen voor een winkelweergave

Wanneer u in een weergavebereik van een winkel werkt, wordt onder het vak _[!UICONTROL Images and Videos]_&#x200B;een selectievakje **[!UICONTROL Use Default Order]**&#x200B;weergegeven. Schakel dit selectievakje in om de weergavevolgorde van de afbeelding te herstellen naar de volgorde die bij het standaardbereik is gedefinieerd.

![&#x200B; beelden en video&#39;s - de Mening van de opslag &#x200B;](./assets/product-images-and-videos-rearrange-store-scope.png){width="600" zoomable="yes"}

### Afbeeldingsdetails instellen voor een winkelweergave

Wanneer u de weergave Afbeeldingsdetails opent in het weergavebereik van de winkel, wordt in elk veld (inclusief **[!UICONTROL Alt Text]** , de afbeeldingstoewijzingen **[!UICONTROL Role]** (Basis, Klein, Miniatuur, Staal) en **[!UICONTROL Hide from Product Page]**) een selectievakje **[!UICONTROL Use Default Value]** weergegeven. Schakel dit selectievakje in om de waarde over te nemen die bij het standaardbereik voor dat veld is geconfigureerd.

![&#x200B; Mening van het Detail van het Beeld - de Mening van de Opslag &#x200B;](./assets/product-image-detail-store-scope.png){width="600" zoomable="yes"}

## Afbeeldingsrollen

| Rol afbeelding | Beschrijving |
|--- |--- |
| [!UICONTROL Thumbnail] | Miniatuurafbeeldingen worden weergegeven in de miniatuurgalerie, winkelwagentje en in sommige blokken, zoals Verwante items. Voorbeeldformaat: 50 x 50 pixels |
| [!UICONTROL Small Image] | De kleine afbeelding wordt gebruikt voor de productafbeeldingen in rubrieken en zoekresultaten en voor het weergeven van de productafbeeldingen die nodig zijn voor secties zoals Up-sells, Cross-sells en de lijst Nieuwe producten. Voorbeeldformaat: 470 x 470 pixels |
| [!UICONTROL Base Image] | De basisafbeelding is de hoofdafbeelding op de pagina met productdetails. Het zoomen van de afbeelding wordt geactiveerd als u een afbeelding uploadt die groter is dan de afbeeldingscontainer. Afhankelijk van het zoomniveau dat u wilt bereiken, moet de basisafbeelding twee- of driemaal zo groot zijn als de container. Voorbeeldgrootten: 470 x 470 pixels (zonder zoomen), 1100 x 1100 pixels (met zoomen) |
| [!UICONTROL Swatch] | A [&#x200B; het monster &#x200B;](swatches.md) kan worden gebruikt om de kleur, het patroon, of de textuur te illustreren. Voorbeeldformaat: 50 x 50 pixels |

{style="table-layout:auto"}

## Watermerken

Als u ten koste gaat van het maken van uw eigen originele productafbeeldingen, is er niet veel dat u kunt doen om te voorkomen dat gewetenloze concurrenten deze afbeeldingen met een muisklik stelen. U kunt ze echter een minder aantrekkelijk doel maken door een watermerk op elke afbeelding te plaatsen om ze als uw eigenschap te identificeren. Een watermerkbestand kan een JPG- (JPEG), GIF- of PNG-afbeelding zijn. Zowel GIF- als PNG-bestandstypen ondersteunen transparante lagen, die kunnen worden gebruikt om het watermerk een transparante achtergrond te geven.

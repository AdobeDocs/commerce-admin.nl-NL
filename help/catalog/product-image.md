...
Wanneer u de **[!UICONTROL Store View]** -kiezer overschakelt naar een specifieke opslagweergave (niet **[!UICONTROL All Store Views]** ), biedt de sectie _[!UICONTROL Images and Videos]_aanvullende besturingselementen voor het beheren van de manier waarop afbeeldingen worden weergegeven voor die winkelweergave zonder dat dit van invloed is op het standaardbereik.

### Afbeeldingen opnieuw ordenen voor een winkelweergave

Wanneer u in een weergavebereik van een winkel werkt, wordt onder het vak _[!UICONTROL Images and Videos]_een selectievakje **[!UICONTROL Use Default Order]**weergegeven. Schakel dit selectievakje in om de weergavevolgorde van de afbeelding te herstellen naar de volgorde die bij het standaardbereik is gedefinieerd.

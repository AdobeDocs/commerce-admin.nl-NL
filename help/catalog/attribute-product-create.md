...
1. Stel **[!UICONTROL Catalog Input Type for Store Owner]** in op een van de volgende opties om het type invoerbesturingselement te bepalen dat wordt gebruikt voor gegevensinvoer:
   ...
   | `Page Builder` | Een volledig werkende [ werkruimte van de Bouwer van de Pagina 1} bij de attributenplaats die het gemakkelijk maakt om het in dienst nemen van inhoud aan de productpagina toe te voegen.](../page-builder/introduction.md) |

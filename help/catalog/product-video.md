...
## Stap 1: YouTube API-sleutel ophalen
...
## Videorollen beheren op het niveau van de archiefmening

Wanneer u een video toevoegt of bewerkt terwijl u in een specifiek weergavebereik van de store werkt (niet **[!UICONTROL All Store Views]** ), wordt met elke optie **[!UICONTROL Role]** in het dialoogvenster Video een knop **[!UICONTROL Use Default Value]** weergegeven. Klik deze knoop om de roltaak van het standaardwerkingsgebied voor die rol te erven.

![&#x200B; Nieuwe Video - de Mening van de Opslag &#x200B;](./assets/product-video-add-store-scope.png){width="600" zoomable="yes"}

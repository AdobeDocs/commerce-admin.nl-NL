...
| [!UICONTROL Allow to Choose State if It is Optional for Country] | Algemeen | Voor landen waar het niet wordt vereist, bepaalt als het _gebied 0} Gebied/Staat {in het postadres van de klant inbegrepen is.<br />_ <br />**`Yes`**- omvat het _Gebied/Staat_ gebied in het klantenadres, zelfs als niet vereist door het land.<br />**`No`** - Laat het gebied/van de Staat van het klantenadres weg als niet vereist door het land. |

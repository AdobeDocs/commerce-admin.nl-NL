...
![E-mailopties - Bedrijfsregistratie](./assets/company-email-options-company-registration.png)<!-- zoom -->
...
![Aan klanten gerelateerde e-mails](./assets/company-email-options-customer-related-emails.png)<!-- zoom -->
...
![Wijziging van bedrijfsstatus](./assets/company-email-options-company-status-change.png)<!-- zoom -->
...
| [!UICONTROL Default "Company Status Change to Active 1' Email] | Winkelweergave | De e-mailsjabloon die wordt gebruikt wanneer de status van een bedrijf verandert van _In behandeling_ tot _Actief_. Standaardsjabloon: `Company Status Active 1` |
| [!UICONTROL Default 'Company Status Change to Active 2' Email] | Winkelweergave | De e-mailsjabloon die standaard wordt gebruikt wanneer de status van een bedrijf verandert van _Geweigerd_ of _Geblokkeerd_ tot _Actief_. Standaardsjabloon: `Company Status Active 2` |
| [!UICONTROL Default 'Company Status Change to Rejected' Email] | Winkelweergave | De e-mailsjabloon die standaard wordt gebruikt wanneer de status van een bedrijf verandert in _Geweigerd_. Standaardsjabloon: `Company Status Rejected` |
...
![Bedrijfskrediet](./assets/company-email-options-company-credit.png)<!-- zoom -->
...
| [!UICONTROL Reimbursed Email Template] | Winkelweergave | De e-mailsjabloon die standaard wordt gebruikt als een [terugbetaling](../../b2b/credit-company.md#apply-a-payment-to-a-company-account) op krediet van de onderneming wordt verstrekt. Deze e-mail wordt verzonden naar de bedrijfbeheerder. Standaardsjabloon: `Credit Reimbursed` |

...
description: Controleer de configuratie-instellingen in het dialoogvenster [!UICONTROL PayPal Payments Pro] de [!UICONTROL Sales] &gt; [!UICONTROL Payment Methods] pagina van de Commerce Admin.
...
>
>**PSD2 Eisen:** <br/>
>Vanaf 14 september 2019 zouden Europese banken betalingen kunnen terugdringen die niet voldoen aan [PSD 2](../../getting-started/compliance-payment-services-directive.md) eisen. Om te voldoen aan PSD2 [!DNL PayPal Payments Pro] moet worden geïntegreerd met [!DNL Cardinal Commerce]. Zie voor meer informatie [3-D veilig voor Payflow](https://developer.paypal.com/api/nvp-soap/payflow/3d-secure-overview/).

{{config}}

## [!UICONTROL Required Settings]

![Vereiste instellingen](./assets/payment-methods-paypal-payments-pro-required.png)<!-- zoom -->
...
![Basisinstellingen](./assets/payment-methods-paypal-payments-pro-basic-settings.png)<!-- zoom -->
...
![Geavanceerde instellingen](./assets/paypal-advanced-settings.png)<!-- zoom -->
...
| [!UICONTROL Header Image Border Color] | Winkelweergave | De hexadecimale kleurcode van zes tekens voor de rand van 2 pixels rond de koptekst. |
...
![Basisinstellingen voor PayPal Express-afhandeling](./assets/payment-methods-paypal-payments-pro-express-checkout-basic-settings.png)<!-- zoom -->
...
![Geavanceerde instellingen voor PayPal Express-afhandeling](./assets/payment-methods-paypal-payments-pro-express-checkout-advanced-settings.png)<!-- zoom -->

| Veld | [Toepassingsgebied](../../getting-started/websites-stores-views.md#scope-settings) | Beschrijving |
|--- |--- |--- |
| [!UICONTROL Display on Shopping Cart] | Winkelweergave | Hiermee wordt bepaald of PayPal Express Checkout wordt weergegeven als een betalingsoptie in het winkelwagentje. Opties: `Yes` (PayPal raadt deze optie aan) / `No` |

...
![Instellingen voor betalingsservices](assets/payment-services-menu-small.png){zoomable: no, width: 400px}
...
![Algemene instellingen](assets/payments-general-settings.png){zoombaar: ja, breedte: 600px}
...
![Instellingen voor creditcardvelden](assets/payments-ccfields-settings.png){zoombaar: ja, breedte: 600px}
...
![Instellingen voor PayPal-betalingsknoppen](assets/payments-ppbuttons-settings.png){zoombaar: ja, breedte: 600px}
...
![Opmaakinstellingen voor PayPal-betalingsknoppen](assets/payments-buttonstyle-settings.png){zoombaar: ja, breedte: 600px}

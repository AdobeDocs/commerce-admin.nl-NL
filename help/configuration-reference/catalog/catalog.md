...
| [!UICONTROL Events to Scroll per Click in Event Slider Widget] | Winkelweergave | Hiermee bepaalt u het aantal gebeurtenissen dat wordt weergegeven in de gebeurtenisschuifregelaarwidget op CMS-pagina&#39;s, zoals de startpagina. Gebruik de variabele `scroll="x"` om deze te overschrijven. |

...
| [!UICONTROL Mask for Meta Keywords] | Algemeen | Bepaalt de standaardwaarde van het _1} gebied van de Sleutelwoorden van Meta {dat op placeholder waarden van andere gebieden en om het even welke extra tekst wordt gebaseerd die is ingegaan._ Standaard tijdelijke aanduiding: <br/> Productnaam - `{{name}}` |
...
![ de Top Navigatie van de Categorie 0} {](./assets/catalog-category-top-navigation.png)<!-- zoom -->

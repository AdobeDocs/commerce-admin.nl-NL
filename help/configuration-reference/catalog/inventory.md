...
| [!UICONTROL Asynchronous batch size] | Algemeen | Stel **[!UICONTROL Run asynchronously]** in op `Yes` om een waarde voor het veld _[!UICONTROL Asynchronous batch size]_in te voeren. <br/> de standaardpartijgrootte is 100. Wanneer de bulkprocessen dit bedrag bereiken, worden zij uitgevoerd. |

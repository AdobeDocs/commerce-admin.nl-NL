...
<table style="table-layout:auto;">
  ...
  <tbody>
    <tr>
      <td><p>Toegevoegde verduidelijking dat <a href="https://experienceleague.adobe.com/en/docs/commerce-admin/systems/security/encryption-key"> het roteren van een encryptiesleutel </a> alle klant en admin zittingen onmiddellijk ongeldig zal maken.</p>
</td>
      <td>
        Technisch
      </td>

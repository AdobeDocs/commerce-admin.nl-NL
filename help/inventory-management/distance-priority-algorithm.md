...
- **MAP van Google** - gebruikt [ de Diensten van het Platform van de Kaarten van Google ](https://cloud.google.com/maps-platform/) om de afstand en de tijd tussen het verschepende bestemmingsadres en bronplaatsen te berekenen. Bij deze optie worden de GPS-coördinaten (Latitude and Longitude) van de bron gebruikt en kan het adres van de straat worden gebruikt, afhankelijk van de berekeningsmodus. Een sleutel van Google API wordt vereist met [ Geocoding API ](https://developers.google.com/maps/documentation/geocoding/start) en [ toegelaten de Matrijs van de Afstand API ](https://developers.google.com/maps/documentation/distance-matrix/start), en u kunt lasten door Google veroorzaken.
...
De sleutel is van het [ Platform van de Kaarten van Google ](https://cloud.google.com/maps-platform/) en zou [ Geocoding API ](https://developers.google.com/maps/documentation/geocoding/start) en [ toegelaten de Matrijs van de Afstand moeten hebben ](https://developers.google.com/maps/documentation/distance-matrix/start). Voor details, zie [ het Vormen het Prioritaire Algoritme van de Afstand ](distance-priority-algorithm.md).

1. Bezoek [ het Platform van de Kaarten van Google ](https://cloud.google.com/maps-platform/) en klik **[!UICONTROL Get Started]**.
...
1. Klik op **[!UICONTROL Console]** om de opties voor het Google Cloud Platform te openen en te configureren.
   ...
   - Onderzoek naar [ Coderen API ](https://developers.google.com/maps/documentation/geocoding/start) en [ Matrijs API van de Afstand ](https://developers.google.com/maps/documentation/distance-matrix/start). Selecteer en laat elke dienst toe.
...
1. Breid ![ selecteur van de Uitbreiding ](../assets/icon-display-expand.png) de _[!UICONTROL Google Distance Provider]_sectie uit en vorm de montages:
   ...
   - Selecteer voor **[!UICONTROL Computation mode]** een configuratie.
     ...
     | `Bicycling` | Verzoekt fietsrichtingen met fietspaden en de voorkeurstraten (indien beschikbaar). De [ Dienst van de Matrijs van de Afstand ](https://developers.google.com/maps/documentation/javascript/distancematrix#travel_modes) is slechts beschikbaar in de V.S. en sommige Canadese steden. |
...
Offlineberekeningen gebruiken landcodes om de afstand tussen de verzendbestemming en de bronadressen te bepalen. Voor deze optie is mogelijk hulp van ontwikkelaars nodig bij het configureren. Gebruik een [!DNL Inventory Management] bevel CLI om gegevens van [ geonames.org ](https://www.geonames.org/) te downloaden en in te voeren.

>[!NOTE]
>
>De ingevoerde geocodes van [ geonames.org ](https://www.geonames.org/) hebben beperkingen voor sommige landen, zoals Canada en Ierland. Verwijs naar [ de dossiers van de Code van GeoNames Postal ](https://download.geonames.org/export/zip/readme.txt) voor meer informatie.

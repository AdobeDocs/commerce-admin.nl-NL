...
- **Bewerker van Gegevens** (de Leveranciers van de Technologie): Adobe Commerce en Magento Open Source handelen als bewerkers van de persoonlijke gegevens die als deel van de diensten worden opgeslagen die aan handelaren worden verleend. Als verwerker verwerkt Adobe persoonsgegevens volgens de toestemming en instructies van de handelaar, overeenkomstig de licentieovereenkomst.
...
1. Stel responsprocedures vast en documenteer elk van de volgende verzoeken:
   ...
   - **Verzoeken om** te schrappen
      ...
      - Handelaren van wie de winkels worden gehost op Adobe Commerce Cloud, kunnen contact opnemen met de Technische Ondersteuning van Adobe voor hulp bij het verwijderen van persoonlijke gegevens. Neem contact op met uw technische accountmanager of klantenondersteuning van Adobe voor meer informatie.
      - Handelaren die installaties van Adobe Commerce of Magento Open Source op locatie uitvoeren, moeten hun eigen proces en script implementeren om persoonlijke gegevens op verzoek te verwijderen.
